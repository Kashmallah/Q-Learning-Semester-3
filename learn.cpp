...
void Learn::showMinimizedMessageBox()
{
    QMessageBox::warning(this, "Alert", "Your Paper has been Cancelled");
    QCoreApplication::exit();

}
bool Learn::eventFilter(QObject *obj, QEvent *event)
{
    ...
    return Learn::eventFilter(obj, event);
}
...
void Learn::on_pushButton_2_clicked()
{
    ui->tabWidget->setTabEnabled(1,false);
    ...
    QStringList select;
    // Add a newline character to the result to ensure that it contains multiple lines of text
    result += "\n";
    select = question_seperator(result);
    ...
    // Reset the counter_question variable to 0
    counter_question = 0;
}

void Learn::on_pushButton_start_2_clicked() /////// Push button Start
{
    ////////////  To start the test
...
void Learn::on_pushButton_15_clicked() /////////Push Button Next
{
    if(counter_answer == 5)
    {
        ui->pushButton_15->setEnabled(false);
...
void Learn::on_pushButton_14_clicked() ////// To Submit the Whole paper
{
    ui->tabWidget->setTabEnabled(2,false);
    ui->tabWidget->setTabEnabled(3,true);
...
void Learn::on_pushButton_4_clicked()
{
...
void Learn::on_pushButton_3_clicked()
{
    QCoreApplication::exit();
}
